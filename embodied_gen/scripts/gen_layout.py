...
def entrypoint() -> None:
    ...
    for idx, task_desc in enumerate(task_descs):
        ...
        layout_info = bfs_placement(layout_info, seed=args.seed_layout)
        ...
        sim_cli(layout_path=layout_path, output_dir=output_root)
...
if __name__ == "__main__":
    entrypoint()
    # TODO: Put background in huggingface or git-lfs
